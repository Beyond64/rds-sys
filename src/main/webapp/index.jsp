...
<head>
  ...
  <<%@include file="resources/common/header.jsp" %>
    ...
    <script>
        var globalWindow; //主窗口变量，一开始就会加载
        var topMenuCache;
        var secondMenuCache = {};
        var thirdMenuCache = {};
...
<div class="easyui-layout" style="width:100%;height:100%;margin:0">
    ...
    <div data-options="region:'north',split:false,border:false"
         style="height:85px;overflow:hidden;background:#0B7CBE url() no-repeat">
        <table align="right" cellpadding="0" cellspacing="0">
            <tr>
               ...
               <%--     <div class="mainmenu" onclick="" onmouseover="mainmenu_over(this)" onmouseout="mainmenu_out(this)">
                        <div style="margin:10px 5px 10px 5px">
                            <img src="/resources/images/32x32/world.png" width="35" height="35"/>
                        </div>
                        <div style="font-size:13px">信息发布</div>
                    </div>
                    <div class="mainmenu" onclick="" onmouseover="mainmenu_over(this)" onmouseout="mainmenu_out(this)">
                        <div style="margin:10px 5px 10px 5px">
                            <img src="/resources/images/32x32/home.png" width="35" height="35"/>
                        </div>
