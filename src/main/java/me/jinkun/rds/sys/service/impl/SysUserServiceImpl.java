...
public class SysUserServiceImpl implements SysUserService {
    ...
    @Override
    public BaseResult saveOrUpdate(SysUserForm form) throws ParseException {
        ...
        if (form.getId() != null) {
            ...
            Date date = new Date();
            String pa = sdf.format(date);
            System.out.println(pa);
            Date d = sdf.parse(pa);
            entity.setCreateTime(d);
            String password= UtilMd5.md5( entity.getPassword(), String.valueOf(d.getTime()));
